...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group flex items-center gap-2 pl-3.5 pr-4 py-3 rounded-full bg-[#25D366] text-white shadow-glow hover:scale-110 hover:shadow-[0_0_30px_rgba(37,211,102,0.6)] transition-smooth"
    >
